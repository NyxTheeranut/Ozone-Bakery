...
<div class="max-w-screen-xl px-4 py-1 sm:px-2 lg:px-2 lg:py-1 mx-auto">
    ...
    <div class="flex flex-row mt-3">
        ...
        <button class="inline-block m-2 mt-4 py-2 px-3 ml-auto rounded-md border border-transparent font-semibold bg-stone-500 text-white text-xl hover:bg-stone-600 transition-all" onclick="onAddIngredientButtonClicked()" id="addIngredientButton" style="display: none;">
            Add Ingredient
        </button>
    </div>
        ...
        <table style="width: 100%; border-collapse: collapse;">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><input class="text-center rounded-3xl border border-stone-300 bg-stone-100 hover:bg-white transition-all" type="text" onchange="onIngredientDetailChange({{ $ingredient->id }})" id="ingredientNameInput{{ $ingredient->id }}" value="{{ $ingredient->name }}"></td>
                    <td><input class="text-center rounded-3xl border border-stone-300 bg-stone-100 hover:bg-white transition-all" type="text" onchange="onIngredientDetailChange({{ $ingredient->id }})" id="ingredientQuantityUnitInput{{ $ingredient->id }}" value="{{ $ingredient->quantity_unit }}"></td>
                    <td style="width: 10%;">
                        <button class="flex flex-wrap block m-2 mt-auto py-2 px-3 ml-auto rounded-md border border-transparent font-semibold bg-stone-500 text-white text-xl hover:bg-stone-600 transition-all" onclick="onSaveIngredientButtonClicked({{ $ingredient->id }})" id="saveIngredientButton{{ $ingredient->id }}" style="display: none">Save</button>
                        <button class="flex flex-wrap block m-2 mt-auto py-2 px-3 ml-auto rounded-md border border-transparent font-semibold bg-stone-500 text-white text-xl hover:bg-stone-600 transition-all" onclick="onDeleteIngredientButtonClicked({{ $ingredient->id }})" id="deleteIngredientButton{{ $ingredient->id }}">Delete</button>
                    </td>
                    @php
                ...
                <tr id="new-ingredient-row" style="display: none;">
                    ...
                    <td style="width: 40%;">
                        <input class="text-left rounded-3xl border border-stone-300 bg-stone-100 hover:bg-white transition-all" type="text" id="new-ingredient-name">
                    </td>
                    <td style="width: 30%;">
                        <input class="text-left rounded-3xl border border-stone-300 bg-stone-100 hover:bg-white transition-all" type="text" id="new-ingredient-quantity-unit">
                    </td>
                    <td class="flex flex-row">
                        <button class="flex flex-wrap block m-2 mt-10 py-2 px-3 ml-auto rounded-md border border-transparent font-semibold bg-stone-500 text-white text-xl hover:bg-stone-600 transition-all" onclick="onSaveNewIngredientButtonClicked()" id="saveNewIngredientButton">Save</button>
                        <button class="block m-2 py-2 px-3 mt-auto rounded-md border border-transparent font-semibold bg-stone-500 text-white text-xl hover:bg-stone-600 transition-all" onclick="onCancelNewIngredientButtonClicked()" id="cancleNewIngredientButton">Cancel</button>
                    </td>
                </tr>
