                ...
                <div class="bg-stone-200 rounded-xl shadow-lg mt-0 mb-4 p-4 sm:p-7" style="width: 100%;">
                    <div class="max-w-sm w-full min-h-[400px] flex flex-col justify-center mx-auto px-6 py-4">
                        ...
                        <div class="mt-5 grid sm:flex gap-2 justify-center">
                            <a href="/products" class="text-3lg py-2 px-3 inline-flex justify-center items-center gap-2 rounded-md border border-transparent font-semibold bg-stone-500 text-white hover:bg-stone-600 focus:outline-none transition-all">
            ...
            <div class="mb-3 flex flex-wrap">
                ...
                <section class="flex flex-col items-stretch w-[40%] ml-5 max-md:w-full">
                    ...
                    <h1 class="text-2xl font-semibold mt-auto mb-3">
                        Quantity: <input class="quantityInput  text-center rounded-3xl border border-stone-300 bg-stone-100 hover:bg-white transition-all" style="border-width: 4px;" type="number" data-cart="{{ $item }}" data-price="{{ $item->product->price }}" onchange="onQuantityInputChange()" style="border-width: 2px;" class="text-center rounded-3xl border border-stone-300 bg-stone-100 hover:bg-white transition-all" name="cart_items[{{ $item->id }}][amount]" value="{{ $item->amount }}" min="0" max="100">
                    </h1>
                </section>
