    ...
    <div class="flex flex-col">
        ...
        <div class="flex flex-wrap max-md:flex-col max-md:items-stretch max-md:gap- ml-20 mr-20 pl-20 pr-20 mx-auto">
            ...
            <div class="flex flex-row items-stretch w-3/12 max-md:w-full mb-5" style="flex: 0 0 25%;">
                <a class="flex flex-col relative shrink-0 box-border h-auto shadow-[3px_-2px_26px_-20px_rgba(0,0,0,1)] w-[300px] self-center mt-5 pb-8 rounded-3xl border-[3px] border-solid border-stone-300">
                    ...
                    <div>
                        <h3 class="text-2xl mx-auto text-center font-bold mt-2">
                            Total:
                            <span id="totalPrice{{$product->id}}" class="productTotalPrice">0</span>
                            Baht
                        </h3>
        ...
        <div class="flex flex-row w-full justify-center">
            ...
            <div class="flex flex-row ml-20 mb-auto w-[60%]">
                ...
                <textarea name="description" id="description" cols="30" rows="10" class="ml-5 mr-5 text-xl" style="width: 100%;" placeholder="Describe your custom bakery order (e.g., flavors, design, dietary needs)."></textarea>
            </div>
