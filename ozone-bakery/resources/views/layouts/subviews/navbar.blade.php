<nav class="bg-white border-gray-200 py-2.5">
    <div class="flex flex-wrap items-center justify-between max-w-screen-3xl mx-auto ">
        <a href="/" class="flex items-center ml-5">
            <img src="https://icons.veryicon.com/png/o/food--drinks/sweet-dessert-icon/croissant-18.png"
            ...
            <div class="flex items-center">
                <div class="dropdown">
                    <a href="" class="ml-auto">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-6 mr-3 sm:h-6" fill="currentColor"
                            viewBox="0 0 16 16">
                            <path
                                d="M8 16a2 2 0 0 0 2-2H6a2 2 0 0 0 2 2zM8 1.918l-.797.161A4.002 4.002 0 0 0 4 6c0 .628-.134 2.197-.459 3.742-.16.767-.376 1.566-.663 2.258h10.244c-.287-.692-.502-1.49-.663-2.258C12.134 8.197 12 6.628 12 6a4.002 4.002 0 0 0-3.203-3.92L8 1.917zM14.22 12c.223.447.481.801.78 1H1c.299-.199.557-.553.78-1C2.68 10.2 3 6.88 3 6c0-2.42 1.72-4.44 4.005-4.901a1 1 0 1 1 1.99 0A5.002 5.002 0 0 1 13 6c0 .88.32 4.2 1.22 6z" />
                        </svg>
                        <span
                            class="absolute top-0 right-0 inline-flex items-center w-3.5 h-3.5 mr-4 rounded-full border-2 border-white text-xs font-medium transform -translate-y-1/2 translate-x-1/2 bg-green-500 text-white">
                ...
                <a class="ml-auto" href="{{ route('cart', ['user' => Auth::user()]) }}"
                    ...
                    <img src="https://cdn.icon-icons.com/icons2/2714/PNG/512/shopping_cart_thin_icon_171537.png"
                        class="h- mr-3 sm:h-7" alt="Logo">
                </a>
                @if (Auth::check())
                ...
                @else
                    <div class="mx-4 font-semibold" style="color: black;">
                        ...
                        <div class="dropdown">
                            <img src="https://static.thenounproject.com/png/4613668-200.png" class="h- mr-3 sm:h-9"
                                alt="Logo">
                            <div class="dropdown-content">
                ...
                @if (Auth::check() && Auth::user()->is_admin == 1)
                    ...
                    <li>
                        <a href="{{ url('/ingredients') }}"
                            class="nav-menu {{ request()->is('ingredients') ? 'active' : '' }}">
                            Ingredients
                        </a>
                    </li>
                    <li>
                        <a href="{{ url('/orders') }}"
                            class="nav-menu {{ request()->is('customer-orders') ? 'active' : '' }}">
                            orders
                        </a>
                    </li>
                @else
