            ...
            <div class="mb-3 flex flex-wrap">
                ...
                <section class="flex flex-col items-stretch w-[50%] max-md:w-full max-md:h-full">
                    <p class="mb-auto mr-10 pb-4 text-right text-2xl font-semibold">
                        ...
                        <button id="confirmOrderButton" onclick="onConfirmOrderButtonClicked()" style="margin-top: 300px;" class="bg-pink-200 flex flex-wrap block mt-auto py-2 px-3 ml-auto rounded-md border border-transparent font-semibold bg-stone-500 text-white text-xl hover:bg-stone-600 transition-all text-sm rounded-3xl">
                            Confirm Order
                        </button>
                    </p>
                </section>
...
<script>
    ...
    function onConfirmOrderButtonClicked() {
        ...
        if (!confirm('Are you sure you want to confirm this order? Please ensure that you have made the payment for this order to proceed.')) {
            return; 
        }
