        ...
        <div class="flex flex-col">
            <div class="flex justify-content-between">
                ...
                <div class="flex flex-col items-stretch w-6/12 ml-5 max-md:w-full">
                    <a href="#"
                        class=" shrink-0 box-borderbg-stone-500 text-white no-underline text-base mx-auto px-5 py-2.5 rounded-3xl hover:bg-stone-600 ml-auto  mt-5 mr-20 bg-stone-500">
                        Add ingredient
                    </a>
                </div>
            </div>
